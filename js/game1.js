...
function init() {
   ...
   // Creating the walls
   leftFloor = createStaticBox(world, -12, 23, 30, 4);
   rightFloor = createStaticBox(world, 55, 23, 30, 4);
